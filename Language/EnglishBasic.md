...
学习英语抱着以终为始的心态,学习过程中牢记你的目的是什么,怎么样达到目的,为什么要学英语,目前你的水平距离你希望达到的目的还有多远.  
对于想去外企或者想remote甚至relocation的程序员来说,英语实际上并不难,举个我身边的例子,我目前在一家外企就职,其中很多在美国的程序员同事的英语口语水平其实远不及native speaker的,但是他们能熟练的使用英语开会,交流需求,写文档,完成工作,重要的是能**用英语表述你想传递的信息**,而不是用一些高大上的词汇或者非常高级的表述.
